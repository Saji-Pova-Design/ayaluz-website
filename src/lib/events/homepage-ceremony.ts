...
export const homepageCeremonyEvent: SingleDayCeremonyEvent =
  {
    type: "single-day",
    ...
    image:
      "/images/homepage/photos/Aya-cup.jpg",
    ...
    features: [
      {
        ...
        icon:
          "/images/homepage/icons/moon.png",
...

      {
        ...
        label:
          "Couldn’t manage transportation back? You’re welcome to stay overnight at the temple",
      },
...

      {
        ...
        icon:
          "/images/homepage/icons/translate.png",
