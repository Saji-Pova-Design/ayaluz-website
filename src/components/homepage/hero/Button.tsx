...
> = {
  ...
  text:
    "text-light underline-offset-4 hover:underline bg-transparent px-0 py-0 min-h-0",
};
...
export function Button(
  ...
  const base =
    "group inline-flex min-h-[48px] items-center justify-center gap-2 rounded-[8px] px-6 py-3 font-canela text-[15px] tracking-[0.02em] transition-all duration-300 ease-out";
