...
export default function ContentImageTop({ data }: Props) {
  const imageUrl = data?.image ? urlFor(data.image).url() : "";

  return (
    <section className="w-full bg-primary-bg px-5 py-16 md:px-8 md:py-10">
      <div className="mx-auto max-w-6xl">
        {imageUrl ? (
          <div className="relative mb-10 aspect-[16/9] w-full overflow-hidden rounded-[2rem] md:mb-14">
            <Image
              src={imageUrl}
